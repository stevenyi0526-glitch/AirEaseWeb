...
const SharePoster: React.FC<SharePosterProps> = ({
  ...
  const downloadPoster = useCallback(async () => {
    ...
    try {
      ...
      alert(t('sharePoster.failedGenerate'));
    }
  }, [flight.flightNumber, flight.departureTime, t]);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div className="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-auto shadow-2xl">
        ...
        <div className="flex items-center justify-between p-4 border-b">
          <h2 className="text-lg font-semibold">{t('sharePoster.title')}</h2>
          <button
            onClick={onClose}
          ...
          >
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm mb-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900">{translateAirline(flight.airline)}</p>
            ...
            {score.highlights && score.highlights.length > 0 && (
              <div className="bg-white rounded-xl p-4 shadow-sm">
                <h4 className="text-sm font-semibold text-gray-700 mb-2">{t('sharePoster.highlights')}</h4>
        ...
        <div className="flex items-center gap-3 p-4 border-t bg-gray-50">
          ...
          >
            ...
            <span className="font-medium">{t('sharePoster.saveImage')}</span>
          </button>
          <button
            onClick={sharePoster}
          ...
          >
            ...
            <span className="font-medium">{t('sharePoster.share')}</span>
          </button>
        </div>
      </div>
    </div>
